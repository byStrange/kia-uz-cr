  ...
  <div class="main-body offset-header" header-opacity>
    <div class="special">
      ...
      <div class="block-content bg-color-gray-1">
        <div class="container pv-8 desktop:pv-12 desktop1440:pv-16 download-links">
          <div v-for="(item, key) in page_data.content" :key="key" class="mv-6">
            <div class="text-x4 mb-6 desktop1440:mb-6">{{item.name}}</div>
