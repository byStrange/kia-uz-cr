    ...
    <div class="breadcrumb-container">
      <div class="container-p">
        <ol class="breadcrumb">
          ...
          <li><nuxt-link to="">{{ $t('menu[41]') }}</nuxt-link></li>
        </ol>
      </div>
    </div>
    <div class="feedback">
          ...
          <div class="flex-wrapper">
            <div class="col-2 p-v-20">
              <div class="form-content box-md-5 m-auto">
                <form action="https://cdn.kia.uz/family.php" method="POST" formaj>
                  ...
                  <div class="input-content m-v-30">
                    <div class="m-b-10">{{$t('form.city')}}</div>
                    <div class="models-filter">
                      <select class="js-select" name="city" required>
                        <!-- <option value="">{{page_data.cities.selected}}</option> -->
                        <option v-for="(item, key) in page_data.cities" :key="key" :value="item.name">{{item.name}}</option>
                      </select>
                    </div>
                  </div>
                  <!-- <div class="input-content m-v-30">
                  ...
                  <div class="input-content m-v-30">
                    <div class="m-b-10">{{$t('form.other[0]')}}</div>
                    <div class="models-filter">
